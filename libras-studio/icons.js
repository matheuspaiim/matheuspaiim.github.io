(()=> {
  ...
  const I={
    ...
    learned:wrap(`<path d="M13 35c-3-3-4-7-3-11l1-9c.3-2.5 4-2.4 4 0v7-10c0-2.6 4-2.6 4 0v10-12c0-2.7 4-2.7 4 0v12-10c0-2.6 4-2.6 4 0v11l3-6c1.3-2.5 5-.8 4 1.9l-4 10c-2.4 6.1-6.9 9.1-12 9.1-2.1 0-3.8-.7-5-2z" fill="#ffc3a7" stroke="${stroke}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M36 15c2 1 4 3 5 5M38 28c1-2 2-4 2-6" fill="none" stroke="#7257ee" stroke-width="2.4" stroke-linecap="round"/><circle cx="38.5" cy="12.5" r="2.2" fill="#ffd25f" stroke="${stroke}" stroke-width="1.4"/>`,'#ff9f82','#fff3ee'),
