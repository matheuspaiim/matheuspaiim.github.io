(()=> {
  ...
  const I={
    ...
    learned:wrap(`<path d="M12 34c-3-4-3-8-2-12l1-8c.3-2.5 4-2.4 4 0v7-10c0-2.6 4-2.6 4 0v10-12c0-2.7 4-2.7 4 0v12-10c0-2.6 4-2.6 4 0v11l3-5c1.4-2.4 5-.6 4 2l-4 10c-2.2 5.5-6.2 8.5-11.2 8.5-2.8 0-5.1-1.1-6.8-3.5z" fill="#ffc3a7" stroke="${stroke}" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"/>`,'#ff9f82','#fff3ee'),
